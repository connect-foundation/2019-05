...
const ModalForm = () => {
	return (
		<form className='modal-form'>
			...
			<TimeSection />
			<TextInputSection title='구장' idText='matchStadium' required={Boolean(true)} />
			<TextInputSection title='주소' idText='matchAddress' required={Boolean(false)} />
			<TextInputSection title='비고' idText='matchEtc' required={Boolean(false)} maxlen='50' />
...
const DistrictSection = () => {
	return (
		<div className='district-section input-box'>
			...
			<label htmlFor='matchRegistDistrict' className='match-register__label has-default-value'>
				지역
			</label>
		</div>
	);
	...
	return (
		<div className='date-section input-box'>
			<SingleDatePicker
				...
				required
			/>
			<label htmlFor='matchRegistDate' className='match-register__label has-default-value'>
				날짜
			</label>
		</div>
	);
		...
		<div className='time-container'>
			...
			<div className='time-section end-time'>
				...
				<TimePicker
					...
					theme='classic'
				/>
				<input type='hidden' id='matchRegistEndTime' name='matchRegistEndTime' value={endTime} />
			</div>
		</div>
	);
};
